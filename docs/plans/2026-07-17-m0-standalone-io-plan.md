...
> **Status: draft R10 — PENDING on four open gates (three snapshot decision rows · row-6 read paging · registry-wide generated byte proofs · #1168 canonical wording), per the maintainer P1 addendum ([#1165 comment 5000048510](https://github.com/zts212653/clowder-ai/issues/1165#issuecomment-5000048510)). Complete-and-stable: handshake, framing, digest, settlement, wire-error mapping, registry rows 1–5/7/10–12, DeliveryRejection, K-1 truth, release sequence. Snapshot stays a ★★ DESIGN PACKET; registry deltas all ★-disclosed. Whether approval splits (rows 6/8 detaching) is the maintainer's call. No #1165 body update until #1168 merges and pins canonical wording. No implementation, no beta.3, no re-pin.**
